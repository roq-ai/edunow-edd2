...
function CourseListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<CourseInterface[]>(
    ...
    () =>
      getCourses({
        relations: ['organization', 'user', 'enrollment.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('enrollment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>enrollment</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('enrollment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>{record?._count?.enrollment}</Td>
                    )}
                    <Td>
